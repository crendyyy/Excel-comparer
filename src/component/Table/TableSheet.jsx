...
const TableSheet = ({ task, columns  }) => {
    ...
    const renderCell = (text, record) => {
      ...
      const renderContent = () => {
        if (slug === 'persentase') {
          ...
          return (
            <span className='px-3 py-1 rounded-full' style={{ backgroundColor: color }}>
  ...
  return <Table pagination={false} columns={columnConfig} dataSource={dataSource} />
}
